...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tally.Web.Models.CachedVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Tally.Web.Models.ChannelPoll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Tally.Web.Models.LiveVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Tally.Web.Models.Poll", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Tally.Web.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Tally.Web.Models.CachedVote", b =>
                {
                    b.HasOne("Tally.Web.Models.Option", "Option")
                        .WithMany("CachedVotes")
                        .HasForeignKey("OptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tally.Web.Models.Poll", "Poll")
                        .WithMany("CachedVotes")
            ...
            modelBuilder.Entity("Tally.Web.Models.Poll", b =>
                {
                    b.HasOne("Tally.Web.Models.User", "Creator")
                        .WithMany("Polls")
